...
// Yesとみなす大文字文字列パターン
const std::string
    reversi::KeyboardSelectYesNo::YES_UPPER_STRINGS[YES_UPPER_PATTERN_COUNT] = {
        "Y", "YES"};
// Noとみなす大文字文字列パターン
const std::string
    reversi::KeyboardSelectYesNo::NO_UPPER_STRINGS[NO_UPPER_PATTERN_COUNT] = {
        "N", "NO"};
 ...
 */
bool reversi::KeyboardSelectYesNo::IsSelected() { return isSelected; }

/**
 * Yesを選択したか
 * @return trueならyes falseならno
 */
bool reversi::KeyboardSelectYesNo::IsSelectYes() { return isYes; }

/**
 * 間違った入力をしたか
 * @return trueなら間違った入力をした
 */
bool reversi::KeyboardSelectYesNo::IsWrongInput() { return isWrongInput; }
 ...
 */
bool reversi::KeyboardSelectYesNo::CheckValidString(
 ...
 */
void reversi::KeyboardSelectYesNo::TransformStringUpper(
