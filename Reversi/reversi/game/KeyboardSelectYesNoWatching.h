...
class KeyboardSelectYesNoWatching : public ISelectYesNoWatching {
 private:
  ...
  static const std::string WATCHING_UPPER_STRINGS
      [NO_UPPER_PATTERN_COUNT];  // Watchingとみなす大文字文字列パターン
  // 選択
 ...
 private:
  ...
  reversi::KeyboardSelectYesNoWatching::SELECT_REPLY
      selectReply;    // 選択した返答
