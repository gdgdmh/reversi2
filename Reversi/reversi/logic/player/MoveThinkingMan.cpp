 ...
 * @return          trueなら思考が完了
 */
void reversi::MoveThinkingMan::InitializeMoveThinking(
 ...
 * @return          trueなら思考が完了
 */
bool reversi::MoveThinkingMan::MoveThinking(
    const reversi::Reversi& reversi, const reversi::Move& moveCache,
 ...
 * @return          trueなら入力された
 */
bool reversi::MoveThinkingMan::GetPositionByInput(
    reversi::ReversiConstant::POSITION& position) {
 ...
 * @return      対応した石
 */
reversi::ReversiConstant::BOARD_INFO reversi::MoveThinkingMan::GetTurnToStone(
    reversi::ReversiConstant::TURN turn) {
  ...
  for (int i = 0; i < size; ++i) {
    ...
    for (int j = 0; j < CORNER_COUNT; ++j) {
      reversi::Assert::AssertArrayRange(
          j, CORNER_COUNT, "MoveThinkingMan::CheckPutEnableCorner index over");
 ...
 */
bool reversi::MoveThinkingMan::CheckGetManyStoneChance(
    const reversi::Move& move, int stoneCount) {
