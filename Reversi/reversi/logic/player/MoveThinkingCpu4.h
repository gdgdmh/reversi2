...
class MoveThinkingCpu4 : public IMoveThinking {
 private:
  ...
  static const int
      STATIC_EVALUATION_POINTS[reversi::ReversiConstant::POSITION_SIZE];
 ...
 private:
   ...
   */
  void SetThinkingChildNode(reversi::ThinkingNode* node,
                            const reversi::Reversi& reversi,
                            const reversi::Board& board,
                            reversi::ReversiConstant::TURN selfTurn);
   ...
   */
  void PrintTimeDiff(std::string prefix,
