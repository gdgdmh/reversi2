 ...
 * @return       trueなら思考が完了
 */
bool reversi::MoveThinkingCpu1::MoveThinkingMin(const reversi::Board& board, reversi::MoveInfo& move, reversi::ReversiConstant::TURN turn) {
	// 取れる箇所が最小値の場所を探す
	...
	reversi::Assert::AssertEquals(isUpdate, "MoveThinkingCpu1::MoveThinkingMin ReverseInfo not hit");
 ...
 * @return       trueなら思考が完了
 */
bool reversi::MoveThinkingCpu1::MoveThinkingMinRandom(const reversi::Board& board, reversi::MoveInfo& move, reversi::ReversiConstant::TURN turn) {
	// 取れる箇所が最小値の場所を探す
	...
	// 1つでも打てる箇所があれば引っかかるはず
	reversi::Assert::AssertEquals(minCandidateIndex.size() > 0, "MoveThinkingCpu1::MoveThinkingMinRandom ReverseInfo not hit");
