...
class ReverseInfo {
 public:
  ...
  typedef struct {
    ...
    reversi::ReversiConstant::POSITION reversePositions
        [ReverseInfo::MAX_DIRECTION]
        [reversi::ReversiConstant::
             ONE_MOVE_MAX_REVERSE_COUNT];  // 打ったことで裏返る位置
 ...
 public:
   ...
   * @param turn     手番
   */
  ReverseInfo(reversi::ReversiConstant::POSITION position,
   ...
   */
  void AddReversePosition(reversi::ReverseInfo::DIRECTION direction,
   ...
   * @return           裏返る位置
   */
  reversi::ReversiConstant::POSITION GetReversePosition(
  ...
  GetReversePositionAllDirection() const;
   ...
   * @return 手番情報
   */
  reversi::ReversiConstant::TURN GetTurn() const { return info.turn; }
