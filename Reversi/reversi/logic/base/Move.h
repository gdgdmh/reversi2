...
class Move {
 ...
 public:
   ...
   * @return          裏返し情報
   */
  const reversi::ReverseInfo GetReverseInfo(
      reversi::ReversiConstant::POSITION position) const;
 ...
 public:
   ...
   * @return          trueならその位置に打つことができる
   */
  reversi::ReverseInfo GetEnableMoveInfo(const reversi::Board& board,
                                         int position,
                                         reversi::ReversiConstant::TURN turn);
   ...
   */
  bool CheckMoveInfoDirection(const reversi::Board& board,
                              reversi::ReverseInfo& reverseInfo, int position,
                              DIRECTION direction,
                              reversi::ReversiConstant::TURN turn);
   ...
   * @return                   状態
   */
  reversi::Move::SANDWICH_STATUS GetSandwichInfo(
 ...
 private:
   ...
   */
  reversi::ReverseInfo::DIRECTION ToReverseInfoDirection(
